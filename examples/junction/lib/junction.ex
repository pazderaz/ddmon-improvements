defmodule Junction do
  ...
  def start_roads_and_subscribe do
    ...
    :ddmon.subscribe_deadlocks(:north)
    :ddmon.subscribe_deadlocks(:west)
    :ddmon.subscribe_deadlocks(:south)
    :ddmon.subscribe_deadlocks(:east)
  end
